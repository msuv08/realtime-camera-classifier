...
class App:
    def __init__(self, window=tk.Tk(), window_title="Realtime Camera Classifier"):
        # Window updates
        self.window = window
    ...
    def init_gui(self):
        ...
        self.btn_train = tk.Button(self.window, text="Train ML Model", width=50, command=lambda: self.model.train_model(self.counters))
